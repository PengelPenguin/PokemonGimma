...
namespace PokemonGame.Pokemon
{
    ...
    public partial class Pokemon
    {
        public static Pokemon FromJson(string json) => JsonConvert.DeserializeObject<Pokemon>(json, PokemonGame.Pokemon.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Pokemon self) => JsonConvert.SerializeObject(self, PokemonGame.Pokemon.Converter.Settings);
    }
